...
export class EventsListService{
    ...
    getAllEvents(){
      return this.http.get("http://localhost:8080/root/allevents");
    }

    getEventByID(id:number){
      console.log(id);
     return  this.http.get("http://localhost:8080/root/eventdetails/"+id);
    }
    ...
    saveForm(formValue){
     ...
     // formValue.sessions=[];      
      //EVENTS.push(formValue);
        return this.http.post("http://localhost:8080/root/insert",formValue,this.httpOption);
    }
}
const EVENTS = [];
// const EVENTS =  [
